...
config.key_tables = {
	...
	[herdr_mode.modes.main] = {
		...
		{ key = "p", mods = "ALT", action = herdr_key("p", "ALT") },
		{ key = "t", action = herdr_key("t") },
		{ key = "t", mods = "ALT", action = herdr_key("t", "ALT") },
		...
		{ key = "w", mods = "ALT", action = herdr_key("w", "ALT") },
		...
		{ key = "g", mods = "CTRL", action = herdr_key_table("g", herdr_mode.modes.passthrough, "CTRL") },
		{ key = "?", action = herdr_key_table("?", herdr_mode.modes.passthrough) },
		{ key = "s", action = herdr_key_table("s", herdr_mode.modes.passthrough) },
		{ key = "s", mods = "CTRL", action = herdr_key_table("s", herdr_mode.modes.passthrough, "CTRL") },
