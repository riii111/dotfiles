...
- Flyway checksum mismatch の教訓: `~/.claude/cache/learnings/REDACTED-PROJECT/flyway-checksum-mismatch-deploy-stg.md`
- マージ方向の教訓: `~/.claude/cache/learnings/REDACTED-PROJECT/deploy-branch-merge-direction.md`
