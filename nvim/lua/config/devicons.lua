...
require("nvim-web-devicons").set_icon {
  ...
  kotlin = { icon = "󱈙", color = unified_colors.languages.kotlin, name = "Kotlin" },
  kt = { icon = "󱈙", color = unified_colors.languages.kotlin, name = "Kotlin" },
  kts = { icon = "󱈙", color = unified_colors.languages.kotlin, name = "KotlinScript" },
...
require("nvim-web-devicons").setup {
  override_by_filename = {
    ...
    ["build.gradle"] = { icon = "󱈙", color = unified_colors.languages.kotlin, name = "Gradle" },
    ["build.gradle.kts"] = { icon = "󱈙", color = unified_colors.languages.kotlin, name = "GradleKotlin" },
