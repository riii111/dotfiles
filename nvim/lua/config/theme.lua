...
-- BufferLine group labels: set dark text on language-colored backgrounds
...
local function apply_bufferline_overrides()
	...
	local labels = {
		{ "BufferLineGoLabel", colors.languages.go },
		{ "BufferLineRsLabel", colors.languages.rust },
		{ "BufferLineLuaLabel", colors.languages.lua },
		{ "BufferLineTsLabel", colors.languages.typescript },
		{ "BufferLineTsxLabel", colors.languages.tsx },
		{ "BufferLineJsLabel", colors.languages.javascript },
		{ "BufferLineJsxLabel", colors.languages.jsx },
		{ "BufferLineCLabel", colors.languages.c },
		{ "BufferLineCppLabel", colors.languages.cpp },
		{ "BufferLineKotlinLabel", colors.languages.kotlin },
		{ "BufferLineDocsLabel", colors.languages.docs },
	}
	for _, label in ipairs(labels) do
		vim.api.nvim_set_hl(0, label[1], { fg = label_fg, bg = label[2] })
	end
